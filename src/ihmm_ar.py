...
def sample_post(sum_yy, sum_xy, sum_xx, n, params):
    ...
    sigma2 = 1.0/np.random.gamma(a_n + 10E-200, 1/b_n + 10E-200)
...
@njit(fastmath=False, error_model="numpy")
def break_sticks_numba(Pi, Beta, phis, sigma2s, alpha0, gamma, u, params, max_extra=10):
    """
...
def sample(y: np.array, 
    ...
    for it in range(n_samples):
        ...
        # break sticks
        pi, betas, phis, sigma2s, K = break_sticks_numba(pi, betas, phis, sigma2s, alpha0, gamma, u, params)
        ...
        if verbose:
            print('Iter: ', it, ", n states: ", phis.size, ", alpha: ", alpha0, ", gamma: ", gamma)
        if it >= burn_in:
            state_means += states
    ...
    return nstate_store, states, y_pred_mean
...
if __name__ == "__main__":
    ...
    # np.savetxt("C:/Users/k2259011/OneDrive - King's College London/Documents/univariate_models/t_bill_results/ihmm_single_state_sample.csv", states, delimiter=',')
    # np.savetxt("C:/Users/k2259011/OneDrive - King's College London/Documents/univariate_models/t_bill_results_clean/ihmm_n_states.csv", n_states, delimiter=',')
    print(pred_density)
